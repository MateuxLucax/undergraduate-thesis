...
\instituicao{Universidade do Estado de Santa Catarina, Centro de Educação Superior do Alto Vale do Itajaí}%
...
\bibliographystyle{PosTextuais/BibliografiaEstilo.bst}	% Elemento Obrigatório

\bibliography{PosTextuais/Bibliografia}	% Elemento Obrigatório
